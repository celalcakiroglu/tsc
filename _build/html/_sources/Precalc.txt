...
2. Axioms of the set of real numbers :math:`\mathbb{R}`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
**Example 3.1** : Factor :math:`x^2+x-2`
...
**Example 3.3** : Factor the polynomial :math:`3x^2+8xy+4y^2` 
...
**Example 3.4**: Find the sum :math:`(x^3-6x^2+2x+4)+(x^3+5x^2-7x)`
...
**Example 3.5** : Factor the polynomial :math:`24x^2+19x+2` 
...
**Example 3.6** : Multiply :math:`(x+2)(x^2+2x+3)`
...
4. :math:`\displaystyle\frac{x^a}{x^b}=x^{a-b}=\displaystyle\frac{1}{x^{b-a}}`

5. :math:`\Big(\displaystyle\frac{x}{y}\Big)^a=\displaystyle\frac{x^a}{y^a}`

6. :math:`x^{-a}=\Big(\displaystyle\frac{1}{x^a}\Big)`

7. :math:`\sqrt{x}=x^{1/2}`

8. :math:`\displaystyle\sqrt[p]{x^n}=x^{n/p}`

**Example 4.1** : Simplify :math:`x^{1/2}x^{1/3}`
...
**Example 4.2** : Simplify :math:`(x^4y^6)^{-1/2}`

**Solution**: Using the second law:

.. math::
	(x^4y^6)^{-1/2}=(x^4)^{-1/2}(y^6)^{-1/2}

Using the third law:

.. math::
	(x^4)^{-1/2}(y^6)^{-1/2}=x^{4\cdot (-1/2)}y^{6\cdot (-1/2)}=x^{-2}y^{-3}	

Using the sixth law:

.. math::
	x^{-2}y^{-3}=\frac{1}{x^2}\cdot\frac{1}{y^3}=\frac{1}{x^2y^3}		

**Example 4.3** : Simplify :math:`(2a^3b^2)(3ab^4)^3`

**Solution**: Using the second law on the second parenthesis:

.. math::
	(2a^3b^2)(3ab^4)^3=	(2a^3b^2)(3^3a^3(b^4)^3)

Using the third law on the expression :math:`(b^4)^3`:

.. math::
	(2a^3b^2)(3^3a^3(b^4)^3)=(2a^3b^2)(3^3a^3(b^12))=(2a^3b^2)(27a^3(b^12))

Grouping factors with the same base

.. math::
	(2a^3b^2)(27a^3(b^12))=(2\cdot 27)(a^3 a^3)(b^2b^12)

Using the first law:

.. math::
	(54)(a^3 a^3)(b^2b^12)=	(54)(a^{3+3})(b^{2+12})=54a^6b^{14}

**Example 4.4** : Simplify :math:`(2\sqrt{x})(3\sqrt[3]{x})`

**Solution**: Using laws 7 and 8:

.. math::
	(2\sqrt{x})(3\sqrt[3]{x})=2x^{1/2}3x^{1/3}

Grouping factors with the same base

.. math::
	2x^{1/2}3x^{1/3}=2\cdot 3\cdot x^{1/2}\cdot x^{1/3}

Using law 1:

.. math::
	(2\cdot 3)\cdot x^{1/2}\cdot x^{1/3}=6x^{1/2+1/3}=6x^{5/6}=6\sqrt[6]{x^5}
